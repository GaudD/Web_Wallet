...
const DropDown: React.FC<DropDownProps> = ({ mnemonic }) => {
  ...
  return (
    <div className="relative w-10/12 pt-5">
      ...
      <div className='flex justify-between pt-6'>
        ...
        <div>
            <button type="button" className="py-2.5 px-4 me-2 mb-2 mt-[10px] text-sm font-roboto text-gray-900 bg-slate-50 rounded-md hover:bg-slate-200">
                Add Wallet
            </button>
